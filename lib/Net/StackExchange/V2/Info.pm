package Net::StackExchange::V2::Info;
...
sub new {
	...
	*info = subname(
	   "Net::StackExchange::V2::Info::info",
	   no_params("info"),
	);
    return $self;
}
1; #END of Net::StackExchange::V2::Info
__END__


=head1 NAME

Net::StackExchange::V2::Info - The great new Net::StackExchange::V2::Info!
...
Perhaps a little code snippet.
    ...
    my $foo = Net::StackExchange::V2::Info->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Net::StackExchange::V2::Info
