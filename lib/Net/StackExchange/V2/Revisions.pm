package Net::StackExchange::V2::Revisions;
...
sub new {
	...
	*revisions = subname(
	   "Net::StackExchange::V2::Revisions::revisions",
	   one_param("revisions"),
	);
    return $self;
}
1; #END of Net::StackExchange::V2::Revisions
__END__
...
Net::StackExchange::V2::Revisions - The great new Net::StackExchange::V2::Revisions!
...
Perhaps a little code snippet.
    ...
    my $foo = Net::StackExchange::V2::Revisions->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Net::StackExchange::V2::Revisions
