package Net::StackExchange::V2::SuggestedEdits;
...
sub new {
	...
	*suggested_edits_all = subname(
	   "Net::StackExchange::V2::SuggestedEdits::suggested_edits_all",
...
__END__
1; # End of Net::StackExchange::V2::SuggestedEdits

=head1 NAME

Net::StackExchange::V2::SuggestedEdits - The great new Net::StackExchange::V2::SuggestedEdits!
...
Perhaps a little code snippet.
    ...
    my $foo = Net::StackExchange::V2::SuggestedEdits->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Net::StackExchange::V2::SuggestedEdits
