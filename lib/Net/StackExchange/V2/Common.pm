...
our @ISA = qw(Exporter);
our @EXPORT = qw(query no_params one_param two_param);
...
#		print Dumper($q);
		...
		if (not defined($param2)) {
			return query($param1, $ids_str , $q);
		} else {
			return query($param1, $ids_str, $param2, $q);
		}
	}
}
sub two_param {
...
#		print Dumper($q);
		...
		# 			return query($param1, $ids_str , $q);
		# 		} else {
		return query($param1, $ids_str, $param2, $ids_str_2, $q);
		# }
	}
}
