package Net::StackExchange::V2::Posts;
...
sub new {
	...
	*posts_all = subname(
	   "Net::StackExchange::V2::Posts::posts_all",
	   no_params("posts"),
	);
	*posts = subname(
	   "Net::StackExchange::V2::Posts::posts",
	   one_param("posts"),
	);
	...
	*posts_suggested_edits = subname(
	   "Net::StackExchange::V2::Posts::posts_suggested_edits",
	   one_param("posts", "suggested-edits"),
	);
    return $self;
}
1; #END of Net::StackExchange::V2::Posts
__END__


=head1 NAME

Net::StackExchange::V2::Posts - The great new Net::StackExchange::V2::Posts!
...
Perhaps a little code snippet.
    ...
    my $foo = Net::StackExchange::V2::Posts->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Net::StackExchange::V2::Posts
