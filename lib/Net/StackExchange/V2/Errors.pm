package Net::StackExchange::V2::Errors;
...
sub new {
	...
	*errors_all = subname(
	   "Net::StackExchange::V2::Errors::errors_all",
	   no_params("errors"),
	);
	*errors = subname(
	   "Net::StackExchange::V2::Errors::errors",
	   one_param("errors"),
	);
    return $self;
}
__END__
1; # End of Net::StackExchange::V2::Errors


=head1 NAME

Net::StackExchange::V2::Errors - The great new Net::StackExchange::V2::Errors!
...
Perhaps a little code snippet.
    ...
    my $foo = Net::StackExchange::V2::Errors->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Net::StackExchange::V2::Errors
